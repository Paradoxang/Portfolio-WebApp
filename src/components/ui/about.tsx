...
const projects: Project[] = [
  ...
  },
  {
    year: "2024",
    name: "MY MOVIE PAGE",
    tag: "Full-stack · .NET 8 + Angular 19",
    desc: "Página web personal con API REST en .NET 8 e interfaz en Angular 19. Persistencia y consultas sobre SQL Server con modelado relacional, versionado con Git.",
    stack: [".NET 8", "Angular 19", "SQL Server", "Git"],
    mark: "MM",
    coverLabel: ".NET · ANGULAR",
  },
  {
    ...
    tag: "SQL Server · Modelado",
    desc: "Diseño e implementación de una BD en SQL Server (modelo entidad-relación, normalización y consultas optimizadas), integrada con una app web con operaciones CRUD.",
    stack: ["SQL Server", "Modelo E-R", "CRUD"],
    mark: "DB",
    coverLabel: "SQL SERVER",
  },
  {
    year: "2025",
