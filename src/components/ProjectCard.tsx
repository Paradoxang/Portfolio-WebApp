  ...
  return (
    ...
    >
      <div className="project-cover shine-hover relative aspect-[4/3] overflow-hidden rounded-xl">
        {project.preview ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center transition-transform duration-500 ease-out group-hover:scale-105">
            <span className="display text-[clamp(45px,6.5vw,78px)] text-neb/25 transition-colors duration-400 group-hover:text-neb/40">
              {project.mark}
            </span>
          </div>
        )}
      ...
      <div className="mt-3 flex items-baseline gap-3">
        <span className="display text-[24px] text-neb">{project.num}</span>
        <div>
